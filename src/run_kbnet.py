...
parser.add_argument(
    "--image_path", type=str, required=True, help="Path to list of image paths"
)
parser.add_argument(
    "--sparse_depth_path",
    type=str,
    required=True,
    help="Path to list of sparse depth paths",
)
parser.add_argument(
    "--intrinsics_path",
    type=str,
    required=True,
    help="Path to list of camera intrinsics paths",
)
parser.add_argument(
    "--ground_truth_path",
    type=str,
    default="",
    help="Path to list of ground truth depth paths",
)
# Input settings
parser.add_argument(
    "--input_channels_image", type=int, default=3, help="Number of input image channels"
)
parser.add_argument(
    "--input_channels_depth", type=int, default=2, help="Number of input depth channels"
)
parser.add_argument(
...
parser.add_argument(
    ...
    nargs="+",
    type=int,
    default=[256, 128, 128, 64, 12],
    help="Space delimited list of filters to use in each block of depth decoder",
)
parser.add_argument(
    "--deconv_type", type=str, default="up", help="Deconvolution type: up, transpose"
)
parser.add_argument(
    "--min_predict_depth",
    type=float,
...
parser.add_argument(
    ...
    type=str,
    default="leaky_relu",
    help="Activation function after each layer",
)
# Evaluation settings
parser.add_argument(
    "--min_evaluate_depth",
...
parser.add_argument(
    "--save_outputs",
    action="store_true",
    help="If set then store inputs and outputs into output path",
)
parser.add_argument(
    "--keep_input_filenames",
    action="store_true",
    help="If set then keep original input filenames",
)
parser.add_argument(
